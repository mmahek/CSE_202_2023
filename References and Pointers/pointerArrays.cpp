...
using namespace std;
int main(){
    int arr[10] = {23, 122, 41, 67};//array a has been initialized with 4 elements only and other 6 elements will be initialized with garbage values 
    cout << "1 - " << arr << endl;//this points to the address of array , first value of array as well
    cout << "2 - " << arr[2] << endl;//this points to the first element or element at 0th index of array
    ...
    cout << "6 - " << *(arr + 1) << endl;// this points to the second element of array
